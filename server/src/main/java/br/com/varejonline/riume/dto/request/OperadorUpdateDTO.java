...
public class OperadorUpdateDTO {
	...
	@Builder
	public OperadorUpdateDTO (Integer id, String nome, String usuario, String senha) {
		this.id = id;
		this.nome = nome;
	...
	@Builder
	public OperadorUpdateDTO (Integer id, String nome, String usuario, String senha, Set<Integer> perfis) {
		this.id = id;
		this.nome = nome;
		this.usuario = usuario;
		this.senha = senha;
